...
class PublicLocationCategoryControllerApi(basePath: kotlin.String = "https://datyar.vaslapp.com:443") : ApiClient(basePath) {
    ...
    fun categoriesList2(acceptLanguage: kotlin.String? = null, ids: kotlin.Array<kotlin.String>? = null, isRoot: kotlin.Boolean? = null, pageNumber: kotlin.Int? = null, pageSize: kotlin.Int? = null, parentId: kotlin.String? = null, sort: kotlin.String? = null, sortKey: kotlin.Array<kotlin.String>? = null, type: kotlin.String? = null): Page_LocationCategoryResultDto_ {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/public/api/v1/locations/categories", query = localVariableQuery, headers = localVariableHeaders
        )
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun getCategory4(categoryId: kotlin.String, acceptLanguage: kotlin.String? = null): LocationCategoryResultDto {
        
        val localVariableHeaders: kotlin.collections.Map<kotlin.String, kotlin.String> = mapOf("Accept-Language" to acceptLanguage.toString())
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/public/api/v1/locations/categories/{categoryId}".replace("{" + "categoryId" + "}", "$categoryId"), headers = localVariableHeaders
        )
