...
class PublicLocationTagControllerApi(basePath: kotlin.String = "https://datyar.vaslapp.com:443") : ApiClient(basePath) {
    ...
    fun get12(id: kotlin.String, acceptLanguage: kotlin.String? = null): LocationTagDto {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/public/api/v1/locations/tags/{id}".replace("{" + "id" + "}", "$id"), headers = localVariableHeaders
        )
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun getList4(acceptLanguage: kotlin.String? = null, pageNumber: kotlin.Int? = null, pageSize: kotlin.Int? = null, sort: kotlin.String? = null, sortKey: kotlin.Array<kotlin.String>? = null): Page_LocationTagDto_ {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/public/api/v1/locations/tags", query = localVariableQuery, headers = localVariableHeaders
        )
